#ifndef __SYSTEM_INFO_CONFIG_LIST_H__
#define __SYSTEM_INFO_CONFIG_LIST_H__
class SystemInfoConfigListRequest
{
public:
	SystemInfoConfigListRequest(const string& json) {
...
class SystemInfoConfigListResponse
{
public:
	SystemInfoConfigListResponse(const string& json) {
		this->Deserialize(json);
	}
	template <typename Writer>
	void Serialize(Writer& writer) const {
